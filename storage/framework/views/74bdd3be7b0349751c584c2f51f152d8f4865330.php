        ...
        <div class="card-body">
            <p class="card-text">
                ...
                <form action="<?php echo e(route('pengguna')); ?>" method="POST">
                    ...
                    <input type="hidden" name="<?php echo e($user->id); ?>">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project\tugas-retno\resources\views/apps/pengguna/edit.blade.php ENDPATH**/ ?>